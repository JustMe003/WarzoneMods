...
function Client_PresentConfigureUI(rootParent)
	...
	if OverridePercentage == nil then OverridePercentage = false end
	...
	SetOverridePercentage = CreateCheckBox(vert).SetText("Override setting 'Can attack by percentage' to true").SetIsChecked(OverridePercentage);
end