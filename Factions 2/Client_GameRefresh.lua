...
function Client_GameRefresh(game)
	...
	if Mod.PublicGameData.VersionNumber == nil or Mod.PublicGameData.VersionNumber < 7 then game.SendGameCustomMessage("Refreshing page...", {Type="updateData"}, function(payload) UI.Alert(payload); end); return; end
