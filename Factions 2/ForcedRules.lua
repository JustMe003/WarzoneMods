function forcedRules(vert, func)
    ...
    newButton(win .. "Diplomacy", vert, "Diplomacy", function() showDiplomacyRules(vert, func) end, "Royal Blue");
    newButton(win .. "Factions", vert, "Factions", function() showFactionRules(vert, func); end, "Royal Blue");
    newButton(win .. "Return", vert, "Return", func, "Orange");
end

function showDiplomacyRules(vert, func)
    local win = "forcedRulesMain";
    destroyWindow(getCurrentWindow());
    if windowExists(win) then
        resetWindow(win);
    ...
    newButton(win .. "Return", vert, "Return", function() forcedRules(vert, func) end, "Orange");
end

function showFactionRules(vert, func)
...
function showFactionsWarRules(vert, func)
...
function showFactionJoinRules(vert, func)
