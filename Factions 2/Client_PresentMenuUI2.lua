...
function showFactionDetails(factionName)
	...
	if playerIsInFaction then
		...
		end).SetInteractable((not faction.PreSetFaction or not Mod.Settings.GlobalSettings.LockPreSetFactions) and not Mod.PlayerGameData.HasPendingRequest[factionName]);
	end
