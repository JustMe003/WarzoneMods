...
function getDragon(p, dragonID)
    ...
    builder.IsVisibleToAllPlayers = Mod.Settings.Dragons[dragonID].IsVisibleToAllPlayers or false;;
    builder.CanBeAirliftedToSelf = Mod.Settings.Dragons[dragonID].CanBeAirliftedToSelf or false;
    builder.CanBeGiftedWithGiftCard = Mod.Settings.Dragons[dragonID].CanBeGiftedWithGiftCard or false;
    builder.CanBeTransferredToTeammate = Mod.Settings.Dragons[dragonID].CanBeTransferredToTeammate or false;
    builder.CanBeAirliftedToTeammate = (builder.CanBeAirliftedToSelf and builder.CanBeTransferredToTeammate) or false;
    builder.IncludeABeforeName = Mod.Settings.Dragons[dragonID].IncludeABeforeName or false;
