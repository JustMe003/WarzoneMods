...
function showDragonSettings(dragon, showAll)
    ...
    CreateLabel(line).SetText(dragon.Name).SetColor(colors.Tan).SetPreferredWidth(#dragon.Name * 5);
    ...
    CreateLabel(line).SetText(dragon.ColorName).SetColor(dragon.Color).SetPreferredWidth(#dragon.Name * 5);
    CreateEmpty(line).SetFlexibleWidth(1);
...
function showGeneralSettings(dragon, root)
    ...
    if dragon.CanBeBought then
        ...
        CreateLabel(line).SetText(dragon.Cost).SetColor(colors.Teal);
    else
    ...
    CreateLabel(line).SetText(dragon.MaxNumOfDragon).SetColor(colors.Teal);
