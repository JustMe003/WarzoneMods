...
function selectSorting()
	...
	CreateButton(root).SetText("By armies").SetColor(colors.Lime).SetOnClick(function() 
			table.sort(playerTerritories, function(a, b) 
				return (#b.Standing.NumArmies.SpecialUnits * 1000000 + b.Standing.NumArmies.NumArmies) > (#a.Standing.NumArmies.SpecialUnits * 1000000 + a.Standing.NumArmies.NumArmies); 
			end);
		end);
end
