...
function Server_AdvanceTurn_End(game, addNewOrder)
	...
	for i, v in pairs(terrCount) do
                local num = (math.min(game.Settings.MinimumArmyBonus, math.floor(v / game.Settings.BonusArmyPer)) * -1) - math.floor(math.max(v - (game.Settings.BonusArmyPer * game.Settings.MinimumArmyBonus), 0) / game.Settings.BonusArmy * 2);
