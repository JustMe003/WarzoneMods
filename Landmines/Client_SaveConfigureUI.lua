function Client_SaveConfigureUI(alert)
    ...
    if Mod.Settings.Cost < 0 then alert("The cost cannot be lower than 0"); end
    ...
    if Mod.Settings.DamageAbsorbed < 0 then alert("The damage absorbed by a Web must be greater than 0"); end
end