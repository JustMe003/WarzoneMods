...
function Client_PresentConfigureUI(rootParent)
    ...
    CreateLabel(root).SetText("The amount of gold to purchase a Web").SetColor(colors.Textcolor);
    ...
    CreateLabel(root).SetText("The damage that is absorbed by a Web").SetColor(colors.Textcolor);
