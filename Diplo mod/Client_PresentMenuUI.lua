...
function showFactionChat()
	...
	for i = #Mod.PublicGameData.Factions[Mod.PublicGameData.PlayerInFaction[game.Us.ID]].FactionChat, 1, -1 do
		...
		newButton(win .. "player" .. i, line, game.Game.Players[message.Player].DisplayName(nil, false) .. ": ", function() showPlayerDetails(message.Player); end, game.Game.Players[message.Player].Color.HtmlColor, true, -1, -1, 1, 1);
