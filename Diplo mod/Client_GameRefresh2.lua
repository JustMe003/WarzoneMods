...
function showAlert(game)
	...
	if playerData.Notifications.Messages ~= nil and count(playerData.Notifications.Messages, function(v) if type(v) == "table" then return #v else return v; end end) > 0 then
