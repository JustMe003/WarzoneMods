...
function showForecast()
    ...
    if allUpcomingStorms == nil then
        ...
        for _, rain in ipairs(Mod.Settings.Data.Normal) do
            ...
            if rain.NotEveryTurn and (rain.StartStorm > TurnNumber or (Mod.PublicGameData.NormalStormsStartTurn ~= nil and Mod.PublicGameData.NormalStormsStartTurn[rain.ID] ~= 0 and TurnNumber < Mod.PublicGameData.NormalStormsStartTurn[rain.ID])) then
