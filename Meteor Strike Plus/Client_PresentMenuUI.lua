...
function showForecast()
    ...
    if stormsThisTurn == nil then
        ...
        for _, rain in ipairs(Mod.Settings.Data.Normal) do
            print(rain.Name, not rain.NotEveryTurn, (TurnNumber >= rain.StartStorm and TurnNumber <= rain.EndStorm), (Mod.PublicGameData.NormalStormsStartTurn[rain.ID] ~= nil and TurnNumber >= Mod.PublicGameData.NormalStormsStartTurn[rain.ID] and TurnNumber <= (rain.EndStorm - rain.StartStorm + 1) + Mod.PublicGameData.NormalStormsStartTurn[rain.ID]));
